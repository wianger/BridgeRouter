...
public:
    ...
    // dump the whole relation graph (call graph + struct alloc/copy/syscall
    // relations) without the key-object filtering applied by dumpKeyStructs().
    void dumpRelationGraph();
};
