...
private:
    ...
    // inlined/wrapper variants frequently seen in modern kernels
    "kmalloc_trace", "__kmalloc_track_caller", "__kmalloc_node_track_caller",
    // slab cache APIs
    "kmem_cache_alloc", "kmem_cache_alloc_lru", "kmem_cache_alloc_node",
    "kmem_cache_alloc_node_trace", "kmem_cache_alloc_trace",
    };
