...
func InsertMySyscall(syscalls []*Syscall, enabled map[*Syscall]bool) {
	...
	syscalls = append(syscalls, meta_init)
	syscalls = append(syscalls, meta_final)
	enabled[meta_init] = true
	enabled[meta_final] = true
}
...
func (target *Target) BuildChoiceTable(corpus []*Prog, enabled map[*Syscall]bool) *ChoiceTable {
	...
	// InsertMySyscall(target.Syscalls, enabled)
