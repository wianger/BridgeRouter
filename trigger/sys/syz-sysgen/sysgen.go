...
func main() {
	...
	for _, OS := range OSList {
		...
		genDir := filepath.Join(*outDir, "sys", OS, "gen")
		osutil.MkdirAll(genDir)
		writeSource(filepath.Join(genDir, "empty.go"), []byte(emptyGenSource))
...
const emptyGenSource = `// Copyright 2021 syzkaller project authors. All rights reserved.
// Use of this source code is governed by Apache 2 LICENSE that can be found in the LICENSE file.
